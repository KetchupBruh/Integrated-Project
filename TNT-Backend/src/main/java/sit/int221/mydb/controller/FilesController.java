...
import sit.int221.mydb.utils.FileInfo;
...
//        boolean file = storageService.delete(filename);
//        return ResponseEntity.ok()
//                .header(HttpHeaders.CONTENT_DISPOSITION, "delete; filename=\"" + file + "\"").body(file);
//    }

//    @DeleteMapping("/files/{filename:.+}")
//    public void deleteFile(@PathVariable String filename) {
//        Resource file = storageService.delete(filename);
//        ResponseEntity.ok()
//                .header(HttpHeaders.CONTENT_DISPOSITION, "delete; filename=\"" + file + "\"").body(file);
//    }
}
